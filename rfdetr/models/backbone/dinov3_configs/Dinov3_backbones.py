...
if __name__ == "__main__":
    ...
    #     pretrained=True,
    #     weights='data/lxs/vllm/code/weight/dinov3/torch/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth',
    #     check_hash=False
    # )
    ...
    #     pretrained=True,
    #     weights='/data/lxs/vllm/code/weight/dinov3/torch/dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth',
    #     check_hash=False
    # )

    # backbone = dinov3_vith16plus(
    #     pretrained=True,
    #     weights='data/lxs/vllm/code/weight/dinov3/torch/dinov3_vith16plus_pretrain_lvd1689m-7c1da9a5.pth',
    #     check_hash=False
    # )

    backbone = dinov3_vit7b16(
        pretrained=True,
        weights='data/lxs/vllm/code/weight/dinov3/torch/dinov3_vit7b16_pretrain_sat493m-a6675841.pth',
        check_hash=False
    )
    ...
    print(f"Number of blocks: {backbone.n_blocks}")


    with torch.no_grad():  
        features = backbone(x)

    print(f"Output feature shape: {features.shape}")  # [1, N, D]

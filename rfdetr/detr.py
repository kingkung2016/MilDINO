...
class RFDETR():
    ...
    def train_from_config(self, config: TrainConfig, **kwargs):
        with open(
            ...
            class_names = [c["name"] for c in anns["categories"]]    #dataset no supercategory
    ...
    def predict(
        ...
        for img in images:
            ...
            # Handle single-channel images (convert to 3-channel)
            if img.shape[0] == 1:
                img = img.repeat(3, 1, 1)  # Replicate single channel to create 3 identical channels
